...
module top ( 
    ...
    (* iopad_external_pin *) input rst_n,                   // Active-Low Reset 
    ...
    assign clk_en = 1'b1; // for oscillator module
    ...
    // STAGE 1: 3-Stage Integrators @50MHz
    reg  [18:0] A1, A2, A3;
    ...
    // STAGE 3: 3-Stage Differentiators
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            tx_data_reg <= C3_wire[18:11]; // final output
        end
    end
